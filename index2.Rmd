...
<img src=img/pilsen.jpg style="width: 800px"><figcaption>Source: [ChooseChicago.com](http://www.choosechicago.com/articles/view/PILSEN-MURALS/472/?FLUSH)</figcaption>
...
<iframe src="chicago-time/chicago_stream.html" frameBorder = '0' scrolling = 'no' width = "850px" height = "500px" position = 'absolute'></iframe>
...
<iframe src="metro-charts/old_gateways.html" frameBorder = '0' scrolling = 'no' width = "800px" height = "600px"></iframe>

---

### New immigrant gateways

<iframe src="metro-charts/new_gateways1.html" frameBorder = '0' scrolling = 'no' width = "800px" height = "600px"></iframe>

---

### Refugee migration, 2014

<iframe src="refugees/refugees1.html" frameBorder = '0' scrolling = 'no' width = "1000px" height = "600px"></iframe>
...
<img src=img/somali.jpg style="width: 850px"><figcaption>Source: [_The New York Times_](http://www.nytimes.com/2014/09/07/us/for-Jihad-recruits-a-pipeline-from-Minnesota-to-militancy.html?_r=0)</figcaption>

---

### St. Paul

<img src=img/hmong.png style="width: 600px"><figcaption>Source: [Twin Cities Daily Planet](http://www.tcdailyplanet.net/finding-great-hmong-food-and-restaurants-st-paul/)</figcaption>
...
<img src=img/manassas.jpeg style="width: 650px"><figcaption>Source: [LRS Latino](http://lrslatino.blogspot.com/2012/02/thoughts-on-9500-liberty.html)</figcaption>
...
* "Mapping Immigrant America": Data from [NHGIS](http://www.nhgis.org); tiles from [Mapbox](http://www.mapbox.com), &copy; [OpenStreetMap contributors](https://www.openstreetmap.org/copyright)
